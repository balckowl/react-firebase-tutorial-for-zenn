            ...
            <div className="container flex justify-between items-center mx-auto px-2 h-20">
                ...
                <nav className="flex items-center gap-3">
                    <ul className="flex gap-3 items-center">
                        <li className="hidden lg:block"><Link to="/create">日記を書く✏️</Link></li>
                    </ul>
                    {user ?
                        (<div className="flex gap-3 items-center">
                            ...
                            <button className="bg-black text-white py-[7px] px-4 rounded-md" onClick={() => signOut(auth)}>Logout</button>
                        </div>) :
